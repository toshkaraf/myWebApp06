...
//            marshaller.setProperty(Marshaller.JAXB_FRAGMENT, true);
            ...
            throw new WebAppException(ExceptionType.XML_ERROR, "Jaxb init failed", e);
        }
    }
    ...
    public <T> T unmarshall(Reader reader)  {
        try {
            ...
            throw new WebAppException(ExceptionType.XML_ERROR, "Jaxb unmarshall failed", e);
        }
    }
    ...
    public void marshall(Object instance, Writer writer) {
        try {
            ...
            throw new WebAppException(ExceptionType.XML_ERROR, "Jaxb marshal failed", e);
        }
    }
}
